...
import { UseFormRegister, FieldValues, useForm, Validate, UseFormReturn } from "react-hook-form";
...
const Input = ({
  ...
  }, [watch(name), observerValue && watch(observerValue), name, observerValue, setError, watch]);
